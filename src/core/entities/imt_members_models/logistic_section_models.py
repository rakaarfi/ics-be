...
class LogisticSectionChief(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="logistic_section_chief")
...
class CommunicationUnitLeader(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="communication_unit_leader")
...
class MedicalUnitLeader(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="medical_unit_leader")
...
class FoodUnitLeader(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="food_unit_leader")
...
class FacilityUnitLeader(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="facility_unit_leader")
...
class SupplyUnitLeader(BaseImtMember, table=True):
    ...
    ics_201_chart: List[Ics201Chart] = Relationship(back_populates="supply_unit_leader")
