from sqlmodel import Field, SQLModel, Relationship, Date
...
class ImtRoster(SQLModel, table=True):
    ...
    incident_commander: Optional["IncidentCommander"] = Relationship(back_populates="imt_rosters")
    deputy_incident_commander: Optional["DeputyIncidentCommander"] = Relationship(back_populates="imt_rosters")
    safety_officer: Optional["SafetyOfficer"] = Relationship(back_populates="imt_rosters")
    public_information_officer: Optional["PublicInformationOfficer"] = Relationship(back_populates="imt_rosters")
    liaison_officer: Optional["LiaisonOfficer"] = Relationship(back_populates="imt_rosters")
    legal_officer: Optional["LegalOfficer"] = Relationship(back_populates="imt_rosters")
    human_capital_officer: Optional["HumanCapitalOfficer"] = Relationship(back_populates="imt_rosters")
    operation_section_chief: Optional["OperationSectionChief"] = Relationship(back_populates="imt_rosters")
    
    # Relasi ke setiap tabel di planning_section.py
    planning_section_chief: Optional["PlanningSectionChief"] = Relationship(back_populates="imt_rosters")
    situation_unit_leader: Optional["SituationUnitLeader"] = Relationship(back_populates="imt_rosters")
    resources_unit_leader: Optional["ResourcesUnitLeader"] = Relationship(back_populates="imt_rosters")
    documentation_unit_leader: Optional["DocumentationUnitLeader"] = Relationship(back_populates="imt_rosters")
    demobilization_unit_leader: Optional["DemobilizationUnitLeader"] = Relationship(back_populates="imt_rosters")
    environmental_unit_leader: Optional["EnvironmentalUnitLeader"] = Relationship(back_populates="imt_rosters")
    technical_specialist: Optional["TechnicalSpecialist"] = Relationship(back_populates="imt_rosters")
    

    # Relasi ke setiap tabel di logistic_section.py
    logistic_section_chief: Optional["LogisticSectionChief"] = Relationship(back_populates="imt_rosters")
    communication_unit_leader: Optional["CommunicationUnitLeader"] = Relationship(back_populates="imt_rosters")
    medical_unit_leader: Optional["MedicalUnitLeader"] = Relationship(back_populates="imt_rosters")
    food_unit_leader: Optional["FoodUnitLeader"] = Relationship(back_populates="imt_rosters")
    facility_unit_leader: Optional["FacilityUnitLeader"] = Relationship(back_populates="imt_rosters")
    supply_unit_leader: Optional["SupplyUnitLeader"] = Relationship(back_populates="imt_rosters")
    transportation_unit_leader: Optional["TransportationUnitLeader"] = Relationship(back_populates="imt_rosters")
    
    # Relasi ke setiap tabel di finance_section.py
    finance_section_chief: Optional["FinanceSectionChief"] = Relationship(back_populates="imt_rosters")
    procurement_unit_leader: Optional["ProcurementUnitLeader"] = Relationship(back_populates="imt_rosters")
    compensation_claim_unit_leader: Optional["CompensationClaimUnitLeader"] = Relationship(back_populates="imt_rosters")
    cost_unit_leader: Optional["CostUnitLeader"] = Relationship(back_populates="imt_rosters")
    time_unit_leader: Optional["TimeUnitLeader"] = Relationship(back_populates="imt_rosters")
