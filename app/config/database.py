...
from app.models.roster import ImtRoster
from app.models.incident_data import IncidentData, OperationalPeriod
from app.models.ics_201 import ResourceSummary, ActionsStrategiesTactics, IcsChart, Ics201
import os

# PostgreSQL connection string URL (use an async driver like asyncpg)
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+asyncpg://rakaarfi:qwertyuiop@172.28.49.140:5432/ics_database")
