...
from app.models.imt_members.main_section import OperationSectionChief
...
@router.get(
    "/read-paginated/", 
    response_model=PaginationResponse[List[OperationSectionChief]]
)
async def read_operation_section_chief_paginated(
    ...
    return await read_paginated_items(OperationSectionChief, page, limit, session, condition)
