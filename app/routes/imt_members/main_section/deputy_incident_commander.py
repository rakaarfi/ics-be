...
from app.models.imt_members.main_section import DeputyIncidentCommander
...
@router.get(
    "/read-paginated/", 
    response_model=PaginationResponse[List[DeputyIncidentCommander]]
)
async def read_deputy_incident_commander_paginated(
    ...
    return await read_paginated_items(DeputyIncidentCommander, page, limit, session, condition)
