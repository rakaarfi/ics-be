...
from app.models.imt_members.main_section import SafetyOfficer
...
async def delete_safety_officer(
    id: int, 
    session: AsyncSession = Depends(get_session)
):
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[SafetyOfficer]])
