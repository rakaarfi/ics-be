...
from app.models.imt_members.main_section import LegalOfficer
...
async def delete_legal_officer(
    id: int, 
    session: AsyncSession = Depends(get_session)
):
...
@router.get(
    "/read-paginated/", 
    response_model=PaginationResponse[List[LegalOfficer]]
)
