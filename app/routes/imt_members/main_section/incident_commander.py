...
from app.models.imt_members.main_section import IncidentCommander
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[IncidentCommander]]
)
async def read_incident_commander_paginated(
    ...
    return await read_paginated_items(IncidentCommander, page, limit, session, condition)
