...
from app.models.imt_members.planning_section import TechnicalSpecialist
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[TechnicalSpecialist]])
async def read_technical_specialist_paginated(
    ...
    return await read_paginated_items(TechnicalSpecialist, page, limit, session, condition)
