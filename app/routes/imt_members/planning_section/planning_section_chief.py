...
from app.models.imt_members.planning_section import PlanningSectionChief
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[PlanningSectionChief]])
async def read_planning_section_chief_paginated(
    ...
    return await read_paginated_items(PlanningSectionChief, page, limit, session, condition)
