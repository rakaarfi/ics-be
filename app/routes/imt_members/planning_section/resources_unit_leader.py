...
from app.models.imt_members.planning_section import ResourcesUnitLeader
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[ResourcesUnitLeader]])
