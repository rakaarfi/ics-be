...
from app.models.imt_members.logistic_section import LogisticSectionChief
...
@router.get("/read-paginated/", 
            response_model=PaginationResponse[List[LogisticSectionChief]])
