...
@router.post(
    "/create/", 
    summary="Create Ics 201",
    description="Create a new Ics 201"
    )
async def create_ics_201(
    item: Ics201, 
...
@router.get(
    "/read-paginated/",
    response_model=PaginationResponse[List[Ics201]]
)
async def read_ics_201_paginated(
    ...
    if search:
        ...
        condition = (
                ...
                func.lower(func.to_char(Ics201.date_initiated, 'YYYY-MM-DD')).like(search_lower) |
                func.lower(func.to_char(Ics201.time_initiated, 'HH24:MI')).like(search_lower) |
