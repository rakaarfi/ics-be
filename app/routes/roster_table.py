...
from app.models.roster import ImtRoster, ImtRosterTable
...
async def read_roster_tables(
    ...
    statement = (
        select(
            ...
            DeputyIncidentCommander.office_phone.label('deputy_incident_commander_office_phone'),
            DeputyIncidentCommander.mobile_phone.label('deputy_incident_commander_mobile_phone'),
            ...
            PublicInformationOfficer.office_phone.label('public_information_officer_office_phone'),
            PublicInformationOfficer.mobile_phone.label('public_information_officer_mobile_phone'),
            ...
            HumanCapitalOfficer.office_phone.label('human_capital_officer_office_phone'),
            HumanCapitalOfficer.mobile_phone.label('human_capital_officer_mobile_phone'),
            
            OperationSectionChief.name.label('operation_section_chief_name'),
            OperationSectionChief.office_phone.label('operation_section_chief_office_phone'),
            OperationSectionChief.mobile_phone.label('operation_section_chief_mobile_phone'),
            
            PlanningSectionChief.name.label('planning_section_chief_name'),
            PlanningSectionChief.office_phone.label('planning_section_chief_office_phone'),
            PlanningSectionChief.mobile_phone.label('planning_section_chief_mobile_phone'),
            
            SituationUnitLeader.name.label('situation_unit_leader_name'),
            SituationUnitLeader.office_phone.label('situation_unit_leader_office_phone'),
            SituationUnitLeader.mobile_phone.label('situation_unit_leader_mobile_phone'),
            
            ResourcesUnitLeader.name.label('resources_unit_leader_name'),
            ResourcesUnitLeader.office_phone.label('resources_unit_leader_office_phone'),
            ResourcesUnitLeader.mobile_phone.label('resources_unit_leader_mobile_phone'),
            
            DocumentationUnitLeader.name.label('documentation_unit_leader_name'),
            DocumentationUnitLeader.office_phone.label('documentation_unit_leader_office_phone'),
            DocumentationUnitLeader.mobile_phone.label('documentation_unit_leader_mobile_phone'),

            DemobilizationUnitLeader.name.label('demobilization_unit_leader_name'),
            DemobilizationUnitLeader.office_phone.label('demobilization_unit_leader_office_phone'),
            DemobilizationUnitLeader.mobile_phone.label('demobilization_unit_leader_mobile_phone'),

            EnvironmentalUnitLeader.name.label('environmental_unit_leader_name'),
            EnvironmentalUnitLeader.office_phone.label('environmental_unit_leader_office_phone'),
            EnvironmentalUnitLeader.mobile_phone.label('environmental_unit_leader_mobile_phone'),
            ...
            LogisticSectionChief.office_phone.label('logistic_section_chief_office_phone'),
            LogisticSectionChief.mobile_phone.label('logistic_section_chief_mobile_phone'),

            CommunicationUnitLeader.name.label('communication_unit_leader_name'),
            CommunicationUnitLeader.office_phone.label('communication_unit_leader_office_phone'),
            CommunicationUnitLeader.mobile_phone.label('communication_unit_leader_mobile_phone'),
            ...
            TransportationUnitLeader.office_phone.label('transportation_unit_leader_office_phone'),
            TransportationUnitLeader.mobile_phone.label('transportation_unit_leader_mobile_phone'),
            
            FinanceSectionChief.name.label('finance_section_chief_name'),
            FinanceSectionChief.office_phone.label('finance_section_chief_office_phone'),
            FinanceSectionChief.mobile_phone.label('finance_section_chief_mobile_phone'),
            
            ProcurementUnitLeader.name.label('procurement_unit_leader_name'),
            ProcurementUnitLeader.office_phone.label('procurement_unit_leader_office_phone'),
            ProcurementUnitLeader.mobile_phone.label('procurement_unit_leader_mobile_phone'),
            
            CompensationClaimUnitLeader.name.label('compensation_claim_unit_leader_name'),
            CompensationClaimUnitLeader.office_phone.label('compensation_claim_unit_leader_office_phone'),
            CompensationClaimUnitLeader.mobile_phone.label('compensation_claim_unit_leader_mobile_phone'),
